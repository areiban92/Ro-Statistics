...
**RoStatictics** un paquete de software gráfico para realizar métodos estadísticos básicos para universitarios desarrollado por el PADLAB de la Universidad Catolica de Cuenca
...
###Nota:
Versión en desarrollo, se podrian presentar algunos problemas.
